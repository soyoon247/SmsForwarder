...
`release.yml`에서 `soyoon247/SmsForwarder` 두 곳을 실제 public 레포 경로로 교체합니다.

```yaml
# Push source to public repo
git remote add public https://...@github.com/soyoon247/SmsForwarder.git  # ← 교체

# Create GitHub Release
repository: soyoon247/SmsForwarder  # ← 교체
```
